...
RUN set -x \
    ...
    && ./configure \
        ...
        --with-modules=mod_tls:mod_quotatab:mod_sql:mod_quotatab_sql:mod_quotatab_file:mod_ifsession:mod_ctrls_admin:mod_auth_otp:mod_sql_sqlite:mod_sql_mysql:mod_ban:mod_readme:mod_sftp:mod_sftp_sql:mod_vroot --enable-nls \
    && make \
